...
data_root = '/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root='/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo/farmland',
        img_dir='images',
        ann_dir='annotations',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    val=dict(
        type='CityscapesDataset',
        data_root='/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo/val',
        img_dir='images',
        ann_dir='annotations',
        pipeline=[
            dict(type='LoadImageFromFile'),
