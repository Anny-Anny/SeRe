...
data_root = '/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo'  # 数据的根路径。
...
data = dict(
    ...
    train=dict(  # 训练数据集配置
        ...
        data_root='/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo/farmland',  # 数据集的根目录。
    ...
    val=dict(  # 验证数据集的配置
        ...
        data_root='/home/xjw/Downloads/code/mmsegmentation-0.21.0/data/xiangtan_oo/val',  # 数据集的根目录。
        img_dir='images',  # 数据集图像的文件夹。
        ann_dir='annotations',  # 数据集注释的文件夹。
        split='val.txt',
