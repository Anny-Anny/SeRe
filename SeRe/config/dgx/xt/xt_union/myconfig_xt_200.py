...
data_root = '/home/dgx/workspace/xjw/data/xiangtan'  # 数据的根路径。
...
data = dict(
    ...
    train=dict(  # 训练数据集配置
        ...
        data_root='/home/dgx/workspace/xjw/data/xiangtan',  # 数据集的根目录。
...
runner = dict(
    ...
    max_epochs=200) # need to change 全部迭代轮数大小，对于 EpochBasedRunner 使用 `max_epochs` 。
